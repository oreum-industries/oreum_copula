...
class ModelA1(mt.BasePYMCModel):
    """Partial architecture: extends ModelA0 with a Gaussian copula
    (but without Jacobian adjustment)
    Uses:
    ...
    def _build(self):
        ...
        with pm.Model(coords=self.coords) as self.model:
            ...
            # NOTE: MVNormal collapses logp to 1 dim
            ...
            # We follow the data-generating process as
            ...
            #   NOTE:
            #   1. Using pm.logcdf(u_d, c_d) as a convenience, then needs pt.exp()
